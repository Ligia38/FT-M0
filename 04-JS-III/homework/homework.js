...
function numeroMasGrande(numeros) {
  ...
  for(let value of numeros) {
    if(value > numeroMasGrande) {
      numeroMasGrande = value;
    }
  }
...
function mesesDelAño(array) {
  ...
  return (tresMeses.length < 3) ? "No se encontraron los meses pedidos" : tresMeses;
}
...
function breakStatement(numero) {
  ...
  return (arr.length < 10) ? "Se interrumpió la ejecución" : arr;
}
